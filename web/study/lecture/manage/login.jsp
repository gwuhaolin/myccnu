...
<div class="container">
	...
	<form class="form-group" action="LoginServlet.jsp" method="post">
		...
		<div class="radio">
			<label>
				<input type="radio" name="target" value="<%=ManageEvent.TARGET_Lecture%>" checked="checked" >
				讲座
			</label>
		</div>
		<div class="radio">
			<label>
				<input type="radio" name="target" value="<%=ManageEvent.TARGET_School%>">
				校园活动
			</label>
		</div>
