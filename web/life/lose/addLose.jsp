	...
	<form action="AddOneServlet.jsp" method="post">
		<div class="panel panel-info">
			...
			<div class="input-group">
				...
				<input type="text" class="form-control" name="location" placeholder="你在什么地方掉了你的物品">
			</div>
			<!--联系方式-->
			<div class="input-group">
				<span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
				<input type="text" class="form-control" name="phone" placeholder="你的电话">
			</div>
		</div>
...
<form action="searchResult.jsp" method="post" style="margin: 0;position: fixed;top: 0;z-index: 100;opacity: 0.8">
	...
	<div class="input-group">
		<input type="text" name="want" class="form-control" placeholder="先搜索看有没有同学捡到你的东西!">
