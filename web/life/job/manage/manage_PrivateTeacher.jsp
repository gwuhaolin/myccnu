...
<div class="container">
	...
	<div class="panel panel-info">
		...
		<form action="ManageServlet.jsp" method="post" class="form-group">
			...
			<%--target--%>
			<input type="hidden" name="target" value="<%=ManageJob.TARGET_PrivateTeacher%>">
...
<script>
	<%=Tool.makeAJAXLoadMoreJS(ManageJob.ChangeCount,"GetJobsManageFormForAJAX.jsp",", target:"+ManageJob.TARGET_PrivateTeacher)%>
</script>
</body>
</html>