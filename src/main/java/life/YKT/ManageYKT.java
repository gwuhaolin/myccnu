...
public class ManageYKT {
	 ...
	 * @throws tool.NetworkException  学校服务器发生异常
	 * @throws tool.ValidateException 身份验证失败
	 */
	public static String getRemain(String XH, String MM) throws NetworkException, ValidateException {
	 ...
	 * @param MM 密码
	 */
	public static List<OneChange> getDetail(String XH, String MM) throws NetworkException, ValidateException {
		...
		List<OneChange> re = new LinkedList<>();
		//解析数据
	 ...
	 * @param MM 密码
	 */
	public static List<OneChange> getHelpMoney(String XH, String MM) throws NetworkException, ValidateException {
	 ...
	 * @param MM 密码
	 */
	public static List<OneChange> getKaoQin(String XH, String MM) throws NetworkException, ValidateException {
