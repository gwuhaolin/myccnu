...
public class ManageNotice {
    ...
    private static final String ManagePassword = "NOTICE";
    public static final int IsOK_YES = 0;//用于标准人工筛选后的信息删除,该信息ok
    private static final int IsOK_NO = 1;//用于标准人工筛选后的信息删除,该信息不符合要求不能被显示
     ...
     *
     * @param orgURL 一篇文章的原地址
     * @return 如果有返回true
     */
    private static boolean DBhasThisOne(String orgURL) {
        Session session = HibernateUtil.getSession();
        Query query = session.createQuery("from MyNoticeEntity as notice where notice.orgUrl=?");
        query.setString(0, orgURL);
     ...
     */
    private static void add_NotSame(List<MyNoticeEntity> noticeEntity) {
        noticeEntity.stream().filter(entity -> !DBhasThisOne(entity.getOrgUrl())).forEach(HibernateUtil::addEntity);
    }
     ...
     *
     * @param document 要处理的html
     * @param baseURL  根URL
     */
    private static Document semanticUI(Document document, String baseURL) {
     ...
     * @return 是否可以被判断为是通知
     */
    private static boolean isNotice(String title) {
        //判断该文章是否符合是重要通知的要求
     ...
     * 获得该链接的标题
     *
     * @return 从html link中解析出title
     */
    private static String getLinkTitle(Element link) {
        //获得文章的标题
     ...
     */
    private static List<MyNoticeEntity> get0() {
        String form = FromSiteName[0][0];
        LinkedList<MyNoticeEntity> re = new LinkedList<>();
        try {
            ...
            for (int i = 0; i < links.size(); i++) {
                ...
                Thread.sleep(R.ConnectTimeout / 5);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     * @return
     */
    private static List<MyNoticeEntity> get1() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get2() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get3() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get4() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get5() {
            ...
            for (int i = 0; i < links.size(); i++) {
                ...
                if (isNotice(title)) {
                    try {
                        ...
                        dateStr = dateStr.substring(tempIndex + 3, dateStr.indexOf("点", tempIndex));
                        dateStr = parseDateStr(dateStr);
     ...
     * @return
     */
    private static List<MyNoticeEntity> get6() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get7() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get8() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get9() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get10() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get11() {
     ...
     * @return
     */
    private static List<MyNoticeEntity> get12() {
