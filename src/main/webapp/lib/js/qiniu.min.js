function QiniuJsSDK() {
    ...
    this.uploader = function (b) {
        ...
        var f = "", g = function () {
            ...
            f && 9 >= f && b.chunk_size && b.runtimes.indexOf("flash") >= 0 ? b.chunk_size = 0 : (c = 20, d = 4 << c, e = plupload.parseSize(b.chunk_size), e > d && (b.chunk_size = d))
        };
        g();
        var h = function () {
        ...
        return j.bind("Init", function () {
            ...
            c = c || a.settings && a.settings.auto_start, c && $.each(b, function () {
                a.start()
            }), a.refresh()
            ...
            var e = function (c, d, e) {
                ...
                c.setOption({url: "http://up.qiniu.com/", multipart: !0, chunk_size: void 0, multipart_params: f})
            ...
            h = h || b.settings && b.settings.chunk_size, h > g && b.setOption({url: "http://up.qiniu.com/mkblk/" + g})
            ...
            return function (d, e, g) {
                ...
                if (f = f ? f : k.ctx) {
                    ...
                    var q = "http://up.qiniu.com/mkfile/" + e.size + l + o, r = a.createAjax();
